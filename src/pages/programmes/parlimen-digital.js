...
const ParlimenDigitalPage = ({data}) => {
  ...
  const programmeInfo = {
    ...
    workshop: [
      ...
      {
        key: 4,
        title: 'Fundraising for a Cause (Introduction to Grant Writings for Beginners)',
          ...
          <div className='w-full lg:flex '>
            ...
            <div
              ...
              <Img
                ...
                fluid={
                  parlimenDigital.frontmatter.featuredImage.childImageSharp.fluid
                }
        ...
        <section id='objective'>
          <div className='w-full my-8'>
            ...
            <div className='py-2'>
              ...
              After organising Parlimen Digital, Undi18 held Akademi Parlimen Digital, a series of 
              five workshops to empower and educate the participants on various aspects of advocacy 
              and how utilise their resources to create an impactful response. 
              </p>
            </div>
...
export const pageQuery = graphql`
  query ParlimenDigitalPageQuery {
    parlimenDigital: markdownRemark(frontmatter: { title: { eq: "Parlimen Digital" } }) {
      frontmatter {
        title
        featuredImage {
          childImageSharp {
